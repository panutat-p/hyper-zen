...
`status-icon` shows a menu-bar icon, prevents idle system and display sleep, and generates a small input nudge every 60 seconds. Its icon is colored only when Accessibility is allowed.
